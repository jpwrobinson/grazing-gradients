...
**Figure S`r i` | Map of study sites with benthic habitat regimes (B) and herbivore biomass levels (C).** Survey sites are coloured by regimes identified in k-cluster analysis (rubble = yellow, macroalgae = green, substrate = blue, coral = red), and bar plots show mean grazing biomass (± 2 standard errors) for croppers and scrapers.

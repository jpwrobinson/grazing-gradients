...
These different herbivore functional groups and thus their functions, are controlled by both benthic habitat changes and top down fishing pressure. Because algae can proliferate in the absence of grazing pressure [@Mumby2006, @Burkepile2008], correlative analyses of fished reef ecosystems have identified grazing biomass thresholds below which reefs become algae dominated [@Graham2015, @Jouffray2015, @Robinson2018]. As herbivore populations are overexploited across the tropics [@Edwards2014], it is therefore implied that grazing functions are comprimised on inhabited reefs. However, fishing effects can be compounded by bottom-up structuring of herbivore assemblages [@Russ2015], whereby differences in habitat associations among individual taxa cause herbivore populations to vary among neigbouring habitat types <!-- i find this part of this sentence here confusing but i'm not sure how to change it -->[@Doropoulus2013] and reorganize in response to changes in benthic composition [@Gilmour2013]. For example, cropper and scraper biomass is maximised on reefs with intact coral architecture [@Heenan2016], but also on reefs with high availability of algal material and dead coral substrate [@Wilson2006, @Gilmour2013, @Robinson2018]. Grazing biomass of browsing species varies among reef zones of coral-dominated habitats [@Hoey2013] and, in seaweed habitats, shifts predictably with macroalgal density [@Hoey2011, @Robinson2018]. Thus, herbivore assemblage structure is mediated by both habitat composition and fishing intensity. Consequently, to understand how functional feeding groups are distributed at larger scales, such as across reef regions, we must disentangle bottom-up processes from disrupting anthropogenic influences such as fishing. This analysis could then be used to infer constraints on grazing function under different scenarios of habitat degradation and fishing pressure.

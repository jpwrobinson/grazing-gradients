...
```{r,echo=F, fig.align='center', fig.cap = 'Figure 8: Browser bite rates by genera and species. Points are median posterior predictions, with 95% certainty intervals.', fig.width= 8, fig.height = 5}

...
```{r, echo=FALSE, include=TRUE, messages=FALSE, fig.align='center', fig.cap='Figure 4: fishing effects on grazers', fig.width=4, fig.height=4}
...
hist(h$browserlog10, main = 'browser biomass distribution', xlab='Biomass', cex.main=0.8)
...
```{r, echo=FALSE, include=TRUE, messages=FALSE, fig.align='center', fig.cap = 'Figure 3: Benthic effects on browsers', fig.width=9, fig.height=4}

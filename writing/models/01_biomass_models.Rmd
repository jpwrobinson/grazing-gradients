...
As biomasses of grazers, scrapers, and browsers increased, so did the fishable biomass (Fig. 2c) of each group. This effect was strongly pronounced for browsers, while that for grazers and scrapers was comparable.

Effect sizes (Fig. 2d) expectedly also varied across the three functional groups. Herbivore grazers...

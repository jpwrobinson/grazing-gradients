...
ggplot(h, aes(log10(cropping.gram.ha), log10(biom), col=dataset)) +geom_point() + ylab('Biomass (log10 kg/ha)') + xlab('log10 algae removed (grams/ha/minute)') 
```

pairs2(data.frame(h$hard.coral, h$macroalgae, h$rubble, h$substrate, h$complexity, h$management, h$fish.biom, h$cropping.gram.ha), 
